...
<body class="bg-gray-50 text-gray-900">
  ...
  <div class="w-full mx-auto">
    ...
    <div class="max-w-7xl mx-auto px-4 py-12">
      <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-8 relative pb-3 inline-block">
        Sản phẩm nổi bật
        <span class="absolute bottom-0 left-0 w-2/3 h-1 bg-green-600"></span>
      </h2>
      
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <?php
        // Lấy sản phẩm nổi bật từ controller/model (giả sử đã được truyền vào view)
        if (!empty($featured_products) && is_array($featured_products)):
          foreach($featured_products as $product):
            ...
            $price_html = !empty($product['sale_price']) ? 
              '<p class="text-lg font-bold text-green-600">'.number_format($product['sale_price']).' ₫ <span class="text-sm line-through text-gray-500">'.number_format($product['price']).' ₫</span></p>' :
              '<p class="text-lg font-bold text-green-600">'.number_format($product['price']).' ₫</p>';
        ?>
          <div class="bg-white rounded-lg overflow-hidden shadow product-card">
            <a href="index.php?action=product&slug=<?= $product['slug'] ?>">
              ...
              <div class="p-4">
                ...
                <?= $price_html ?>
                <button class="mt-3 w-full bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded transition">
        ...
        ?>
          ...
          <div class="bg-white rounded-lg overflow-hidden shadow product-card">
            ...
            <div class="p-4">
              ...
              <p class="text-lg font-bold text-green-600">320.000 ₫</p>
              <button class="mt-3 w-full bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded transition">
                <i class="fas fa-cart-plus mr-2"></i>Thêm vào giỏ
              </button>
            </div>
      ...
      <div class="text-center mt-8">
        <a href="index.php?action=products&featured=1" class="inline-block bg-white border border-green-600 text-green-600 hover:bg-green-600 hover:text-white py-2 px-6 rounded-full transition">
      ...
      <div class="max-w-7xl mx-auto px-4">
        <div class="flex flex-col md:flex-row items-center gap-8">
          ...
          <div class="w-full md:w-1/2 text-center md:text-left">
            <h2 class="text-xl font-semibold mb-2 text-green-700">KHUYẾN MÃI ĐẶC BIỆT</h2>
            ...
            <a href="index.php?action=products&sale=1" class="inline-block bg-green-600 text-white px-6 py-3 rounded-full hover:bg-green-700 transition">
              Mua ngay
            </a>
          </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 py-12">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <?php
        // Lấy sản phẩm mới từ controller/model (giả sử đã được truyền vào view)
        ...
        ?>
          ...
          <div class="bg-white rounded-lg overflow-hidden shadow product-card">
            ...
            <div class="p-4">
              ...
              <p class="text-lg font-bold text-green-600">450.000 ₫</p>
              <button class="mt-3 w-full bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded transition">
                <i class="fas fa-cart-plus mr-2"></i>Thêm vào giỏ
              </button>
            </div>
      ...
      <div class="text-center mt-8">
        <a href="index.php?action=products&new=1" class="inline-block bg-white border border-green-600 text-green-600 hover:bg-green-600 hover:text-white py-2 px-6 rounded-full transition">
      ...
      <div class="max-w-7xl mx-auto px-4">
        <div class="flex flex-col md:flex-row items-center gap-8">
          ...
          <div class="w-full md:w-1/3 text-center md:text-left">
            <h2 class="text-xl font-semibold mb-2 text-green-700">BỘ SƯU TẬP</h2>
            ...
            <a href="index.php?action=products&collection=xuan-he-2025" class="inline-block bg-gray-800 text-white px-6 py-3 rounded-full hover:bg-gray-700 transition">
              Khám phá ngay
            </a>
          </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 py-12">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <?php
        // Lấy sản phẩm bán chạy từ controller/model (giả sử đã được truyền vào view)
        if (!empty($bestseller_products) && is_array($bestseller_products)):
        ...
        ?>
          ...
          <div class="bg-white rounded-lg overflow-hidden shadow product-card">
            ...
            <div class="p-4">
              ...
              <p class="text-lg font-bold text-green-600">390.000 ₫</p>
              <button class="mt-3 w-full bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded transition">
                <i class="fas fa-cart-plus mr-2"></i>Thêm vào giỏ
              </button>
            </div>
      ...
      <div class="text-center mt-8">
        <a href="index.php?action=products&bestseller=1" class="inline-block bg-white border border-green-600 text-green-600 hover:bg-green-600 hover:text-white py-2 px-6 rounded-full transition">
    ...
    <div class="bg-white py-16 px-4">
      <div class="max-w-5xl mx-auto text-center">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
          <a href="#" class="bg-gray-800 hover:bg-gray-700 text-white rounded-lg inline-flex items-center justify-center px-6 py-3 w-full sm:w-auto">
  ...
  <!-- Thêm JavaScript cho xử lý thêm vào giỏ hàng và các chức năng khác -->
  <script>
    // Xử lý thêm vào giỏ hàng - sẽ cần cập nhật theo logic của ứng dụng
    document.addEventListener('DOMContentLoaded', function() {
      ...
      addToCartButtons.forEach(button => {
        button.addEventListener('click', function(e) {
          ...
          // Code AJAX sẽ được thêm vào đây
