        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><i class="fas fa-map-marker-alt me-2"></i> 368 Lý Thường Kiệt, Quận 10, TP. Hồ Chí Minh</li>
                        <li class="mb-2"><i class="fas fa-phone-alt me-2"></i> 1900 xxxx</li>
                        <li class="mb-2"><i class="fas fa-envelope me-2"></i> info@lmh.com</li>
...
<!-- <footer class="dark:bg-gray-1000 " style="background-color: rgb(245 245 245/var(--tw-bg-opacity,1));">
    <div class="mx-auto w-full max-w-full">
      <div class="grid grid-cols-2 gap-12 px-10 py-6 lg:py-8 md:grid-cols-4  justify-items-center ">
        ...
        <div>
            <h2 class="mb-6 text-3xl font-semibold text-gray-900 uppercase dark:text-white">Help center</h2>
            <ul class="text-gray-500 dark:text-gray-400 font-medium text-2xl">
                <li class="mb-4">
        ...
        <div>
            <h2 class="mb-6 text-3xl font-semibold text-gray-900 uppercase dark:text-white ">Legal</h2>
            <ul class="text-gray-500 dark:text-gray-400 font-medium text-2xl">
                <li class="mb-4">
        ...
        <div>
            <h2 class="mb-6 text-3xl font-semibold text-gray-900 uppercase dark:text-white ">Download</h2>
            <ul class="text-gray-500 dark:text-gray-400 font-medium text-2xl">
                <li class="mb-4">
    ...
    <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-2xl text-gray-500 dark:text-gray-300 sm:text-center ">© 2023 <a href="https://flowbite.com/">Flowbite™</a>. All Rights Reserved.
        </span>
        <div class="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse text-3xl">
